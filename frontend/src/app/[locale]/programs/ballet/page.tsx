...
export default function BalletPage() {
  ...
  return (
    <div className="pt-16">
      {/* Hero Section */}
      <section className="relative min-h-[270px] overflow-hidden bg-gradient-to-r from-purple-600 to-blue-600 py-8 md:h-[400px] md:py-0">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white relative z-10 px-4">
            ...
            />
            <h1 className="heading-xl mb-4 text-white">{t('programs.ballet.title')}</h1>
      ...
      <section className="section-padding">
        <div className="container">
          <div className="mb-10 grid grid-cols-1 items-center gap-6 md:mb-16 lg:grid-cols-2 lg:gap-12">
            <div>
              <h2 className="heading-lg mb-6">{t('programs.ballet.title')}</h2>
            ...
            <div className="rounded-2xl overflow-hidden shadow-xl">
              <img src="/programs/ballet.jpg" alt="Ballet" className="h-64 w-full object-cover sm:h-80 md:h-[400px]" />
            </div>
          </div>
              ...
              {features.map((feature) => {
                ...
                return (
                  <Card key={feature.title} className="text-center">
                    <CardHeader>
                      <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-violet-500 text-white mx-auto mb-4">
